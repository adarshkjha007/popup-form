document.addEventListener("DOMContentLoaded", function () {
  // Only run this on individual blog posts (not homepage or archive)
  const isPostPage = window.location.href.includes('/202'); // Blogger posts usually have /202X in URL
...
`;
  ...
  // Auto open popup after 2s on post pages
